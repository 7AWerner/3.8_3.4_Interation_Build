...
<body>
	<header class="page-header">
		...
		<h1 style="font-size:3vw;">ROK Music</h1>	
			<div class="link"> <!--This is the nav -->
				<ul>
	...
	<div class = "container">
		<div class = "section">
			...
			<div class="page">
				<ul>
					<li><a href="query/genre.php" style="font-size:1.7vw;"><h4>Genre A - Z</h4></a></li>
					<li><a href="query/title.php" style="font-size:1.7vw;"><h4>Title/Artist Z - A</h4></a></li>
					<li><a href="query/songID.php" style="font-size:1.7vw;"><h4>Song ID A - Z</h4></a></li>
				</ul>
			</div>
			<br>
			<hr>
			<br>
				...
				<?php
					...
					<a href="index2.php#stop" class="top-link"> <!--This is the up arrow that sends the user to the top of the page -->
