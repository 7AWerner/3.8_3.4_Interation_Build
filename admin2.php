...
<body>
	...
	<div class = "container">
		<div class = "section">
			...
			<div class="page">
				<ul>
					<li><a href="queryAD/genre.php" style="font-size:1.7vw;"><h4>Genre A - Z</h4></a></li>
					<li><a href="queryAD/title.php" style="font-size:1.7vw;"><h4>Title/Artist Z - A</h4></a></li>
					<li><a href="queryAD/songID.php" style="font-size:1.7vw;"><h4>Song ID A - Z</h4></a></li>
				</ul>
			</div>
			<br>
			<hr>
			<br>
				...
				<?php
					...
					<a href="admin2.php#stop" class="top-link">
